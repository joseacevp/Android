...
import com.example.examenresolucion23.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static void reenviarDatos(TextView nombre) {
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_cargar, R.id.nav_crear, R.id.nav_mostrar)
