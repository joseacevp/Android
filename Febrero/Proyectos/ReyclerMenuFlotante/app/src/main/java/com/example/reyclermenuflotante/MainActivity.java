...
public class MainActivity extends AppCompatActivity {
    ...
    //metodos para jestionar los eventos del menu flotante
    public static void matar(TextView dato) {
        Toast.makeText(dato.getContext(), "matar "+ dato.getText(), Toast.LENGTH_SHORT).show();
    }

    public static void sanar(TextView dato) {
        Toast.makeText(dato.getContext(), "sanar  "+ dato.getText(), Toast.LENGTH_SHORT).show();
    }

    public static void enviar(TextView dato) {
        Toast.makeText(dato.getContext(), "enviar  "+ dato.getText(), Toast.LENGTH_SHORT).show();
